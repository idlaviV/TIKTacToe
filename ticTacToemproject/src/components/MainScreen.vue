...
<template>
  <v-card class="bg-black" align="center">
    ...
    <div v-if="winner !== null">
      <v-btn class="my-2 mx-2 bg-white" v-show="!wasEvalApplied" @click="startEval">
        Belohnung anwenden
      </v-btn>
      <v-btn class="my-2 mx-2" variant="outlined" v-show="!wasEvalApplied" @click="skipEval">
        Überspringen
      </v-btn>
      <v-btn class="my-2 mx-2 bg-white" v-show="wasEvalApplied" @click="finishEvaluation">
        Weiter
      </v-btn>
    </div>
  </v-card>
