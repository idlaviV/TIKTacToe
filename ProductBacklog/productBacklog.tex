...
\subsection{Soll-Kriterien}
	\begin{itemize}
		...
		\item[S201] Es gibt auch die Möglichkeit, zwei KIs, oder zwei Nutzer, als Spieler auszuwählen.
		\item[S210] Eine KI kann auch gegen sich selbst spielen.
		...
		\item[S601] Es gibt eine Ansicht, in der am Ende des Spiels die Gewichte durch die Belohnungsstrategie angepasst werden können.
		\item[S605] Bei der Initialisierung einer KI wird die Belohnungsstrategie vom Nutzer ausgewählt.
		\item[S611] Eine Belohnungsstrategie ist die Elimination des letzten Zuges des Verlierers. Falls aus einem Zustand nur Verlustzüge möglich sind, so wird auch der Zug vor diesem Zustand eliminiert.
		...
		\item[S625] Es gibt eine Ansicht, in der am Ende des Spiels die Gewichte der Belohnungsstrategie Fehlerrückführung vom Nutzer angepasst werden können.
		\item[S630] Der Nutzer kann auswählen, dass die konfigurierte Belohnungsstrategie in Zukunft automatisch angewendet wird.
		\item[S701] Während der Auswahl der Belohnungsstrategie wird der Spielverlauf mit alternativen Optionen als Graph angezeigt.
	\end{itemize}
...
\begin{itemize}
	...
	\item Wir implementieren kein Event-Handling für die User-Player.
	\item Der Graph wird nur lazy aus GameBoards berechnet und nicht als eigenes Objekt gespeichert.
	\item Der Nutzer kann die Parameter der Rückführungs-Belohnungsstrategie anpassen. Die Belohnungsstrategie selbst wird beim Generieren der KI festgelegt.
	...
	\item Die Gewichte werden an den Kanten des Graphen visualisiert und zwar als absolute Zahlen.
	\item Wir versuchen nicht den gesamten Graphen zu visualisieren, weil er zu groß ist.
	\item Beim Hovern über Graphknoten werden die alternativen Spielsituationen angezeigt.
\end{itemize}
...
\newcommand{\ymax}{70}
	...
	\draw[very thick] (5,7.5) -- (6,13.5)%M600 abgeschlossen
										...
										-- (12,54);%Abgabe: Alles fertig, neuer Bonus Alternativen
	\draw[dotted] plot [smooth] coordinates {(0,0) (4,7.5) (8,28) (12,48)};
	%Ziele
	...
	\draw (12,48) node[cross, color=gray]{};%Sprint 2?
