...
\subsection{Muss-Kriterien}
	...
	\begin{itemize}
		...
		\item[M700] Der Nutzer kann die gegen die KI Tic-Tac-Toe spielen.%%Neu
	\end{itemize}
...
\subsection{Kann-Kriterien}
	\begin{itemize}
		...
		\item[K800] Statt Tic-Tac-Toe kann auch ein einfaches Brettspiel gespielt werden, für das die KI mit einer ähnlichen Entscheidungsbaum-Struktur trainiert wird.%Umformuliert, damit überprüfbar
