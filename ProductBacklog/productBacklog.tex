...
\subsection{Kann-Kriterien}
	\begin{itemize}
		...
		\item[K110] Bei der Konfiguration der Belohnungsstrategie kann der Nutzer auswählen, dass die KI auch die Gewichte der Züge des Gegners anpasst.
...
\begin{itemize}
	...
	\item Zunächst wird der \texttt{main}-Branch in den feature-Branch gemergt. Der jeweilige Entwickler des Codes ist dafür verantwortlich auf seinem Branch einen Integrationstest durchzuführen.
	\item Eine relevante Änderung am produktiven Code wird nur in den \texttt{main}-Branch gemergt, wenn sie von einer zweiten Person gereviewt wurde. Ein Review wurde durchgeführt, sobald der Reviewer Fragen zum Code beantworten kann und den Code für zufriedenstellend befunden hat. Der Reviewer ist dafür verantwortlich den feature-Branch in den \texttt{main}-Branch zu mergen und auf dem \texttt{main}-Branch einen erneuten Integrationstest durchzuführen.
