...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Graph nur in AI mit berechnung von anzuzeigendem immer ad hoc
		\item Graph lazy, oder nicht?
	\end{itemize}
	\item Wollen wir verschieden Iso-Gruppen um den Graphen verschieden darstellen können?
	\item Wie machen wir die Player Klassen?
\end{itemize}
